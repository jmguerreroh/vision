 ...
 * - Training the classifiers of 13_01 and 13_02 (KNN and SVM) on real data
  ...
  cv::Mat & test_samples, cv::Mat & test_labels)
{
  ...
  for (int cell_row = 0; cell_row < cells_per_col; ++cell_row) {
    ...
    for (int cell_col = 0; cell_col < cells_per_row; ++cell_col) {
      ...
      // pattern used to feed TrainData in 13_01
...
int main(int argc, char ** argv)
{
  ...
  // ========================================
  // Classifier 1: KNN (as introduced in 13_01)
  // ========================================
  ...
  // ========================================
  // Classifier 2: SVM (as introduced in 13_02)
  // ========================================
  ...
  std::cout << "  - Raw pixels already work surprisingly well on clean data;"
            << std::endl;
  std::cout << "    real images need the descriptors of Chapter 9 or learned"
            << std::endl;
