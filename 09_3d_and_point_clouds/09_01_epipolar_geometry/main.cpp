 ...
 * - Matching two views with ORB + ratio test (Chapter 5)
 ...
 * explains WHY the disparity search of 09_02 can afford to scan a single row.
 * Run it twice:
 *
 *   ./09_01_epipolar_geometry                          (unrectified pair)
 *   ./09_01_epipolar_geometry ../../data/aloeL.jpg ../../data/aloeR.jpg
 *
