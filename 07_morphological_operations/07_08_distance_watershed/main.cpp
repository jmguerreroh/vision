 ...
 *
 * The problem it solves: with the tools seen so far (threshold in 06_01,
 * connected components in 06_02), coins that touch each other become ONE
 ...
 *   1. Binarize (Otsu, 06_01)
 *   2. Clean noise with morphological opening (07_02)
 *   3. Sure BACKGROUND = dilation of the blob (07_01)
 *   4. Sure FOREGROUND = high peaks of the distance transform
 *   5. Unknown region = background minus foreground
 *   6. Label the sure regions (connectedComponents, 06_02) -> markers
