 ...
 *
 * The dataset and the train/test split are the same as 11_03, so the accuracy
...
constexpr float TRAIN_RATIO = 0.5f;  // Left half train, right half test (11_03)
...
/**
 * @brief Slices digits.png into samples, split by columns as in 11_03
 */
void buildDataset(
  const cv::Mat & mosaic,
