 ...
 *
 *          Scope note: KNN, SVM and ANN-MLP are developed in the book text;
 *          Decision Trees, Boosting, Random Forest and EM are provided as
 *          EXTENSIONS so you can compare their decision boundaries -- consult
 *          the OpenCV ml documentation for their theory.
 *
 *          Controls:
...
// Same interactive skeleton as 11_01_knn_classification: click to add points, 'r' to run.
MLApp app;
