 ...
 * - Training the classifiers of 11_01 and 11_02 (KNN and SVM) on real data
  ...
  cv::Mat & test_samples, cv::Mat & test_labels)
{
  ...
  for (int cell_row = 0; cell_row < cells_per_col; ++cell_row) {
    ...
    for (int cell_col = 0; cell_col < cells_per_row; ++cell_col) {
      ...
      // pattern used to feed TrainData in 11_01
...
int main(int argc, char ** argv)
{
  ...
  // ========================================
  // Classifier 1: KNN (as introduced in 11_01)
  // ========================================
  ...
  // ========================================
  // Classifier 2: SVM (as introduced in 11_02)
  // ========================================
