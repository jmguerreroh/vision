 ...
 * - Calibrating each camera of a stereo pair (same procedure as 14_01)
 ...
 *   rows are aligned
 *
 * Why rectify. The disparity algorithms of chapter 15 look for the match of a
...
int main(int argc, char ** argv)
{
  ...
  // ========================================
  // Step 1: the same detection as 14_01, but on BOTH cameras
  // ========================================
  ...
  // estimated separately -- exactly as in 14_01. Doing it first lets the
  ...
  // disparity map into 3D coordinates (chapter 15).
  ...
  // The maps are computed once and reused on every frame, as in 14_01. Here
  ...
  std::cout << "That is what turns the disparity search into a 1D scan along"
            << std::endl;
  std::cout << "the row, which is what chapter 15 assumes." << std::endl;
