 ...
 *
 * Usage: ./11_05_pcl_write [path_to_output_pcd]
...
int main(int argc, char ** argv)
{
  ...
  // test_pcd.pcd be kept under version control, so 11_06_pcl_read works on a
  ...
  // Written into data/pcl_data on purpose: the NEXT example (11_06_pcl_read)
  // reads this exact file, regardless of which directory each one runs from.
  // The file is also under version control, so 11_06 does not depend on this
