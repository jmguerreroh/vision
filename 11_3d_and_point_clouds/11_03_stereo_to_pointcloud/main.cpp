 ...
 * - Computing a disparity map with StereoSGBM (same idea as 13_02)
 ...
 * follow: the equation presented in 13_02,
 *
 *     Z = f * b / disparity
 *
 ...
 *
 * @note Plain OpenCV: no opencv_contrib needed (13_02 does need ximgproc for
...
{
  // Load the rectified stereo pair (same images as 13_02)
  ...
  // ========================================
  // Minimal SGBM setup (13_02 explores the parameters and post-filtering
  ...
  // SGBM returns fixed-point disparities scaled by 16 (see 13_02):
