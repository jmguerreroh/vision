 ...
 * explains WHY the disparity search of 15_02 can afford to scan a single row.
 * Run it twice:
 *
 *   ./15_01_epipolar_geometry                          (unrectified pair)
 *   ./15_01_epipolar_geometry ../../data/aloeL.jpg ../../data/aloeR.jpg
 *
