 ...
 *
 * Usage: ./14_11_pcl_registration file1.pcd file2.pcd file3.pcd ...
 * Example: ./14_11_pcl_registration ../../data/pcl_data/capture000*.pcd
...
int main(int argc, char ** argv)
{
  ...
  // Command-line arguments; -h prints the usage. This example takes a VARIABLE
  // number of clouds, which no fixed-slot parser can express, so the list is
  // read straight from argv
  if (pcl::console::find_switch(argc, argv, "-h") ||
    pcl::console::find_switch(argc, argv, "--help"))
  {
    std::cout << "Usage: " << argv[0] << " [file1.pcd file2.pcd ...]"
              << std::endl;
    std::cout << "With no arguments, ../../data/pcl_data/capture000* is used"
              << std::endl;
    return EXIT_SUCCESS;
  }
